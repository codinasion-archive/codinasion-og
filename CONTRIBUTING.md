...
Thank you for investing your time in contributing to our project! Any contribution you make will be reflected on [https://codinasion-og.vercel.app](https://https://codinasion-og.vercel.app/) :sparkles:.
...
If you want to add or modify Codinasion content, [search if an issue already exists](https://github.com/codinasion/codinasion-og/issues). If a related issue doesn't exist, you can open a new issue using a relevant [issue template](https://github.com/codinasion/codinasion-og/issues/new/choose).
...
2. Clone the forked repository.
  ...
  ```
  git clone https://github.com/your_username/codinasion-og
  ```
...
Once your PR is merged, your contributions will be publicly visible on the [https://codinasion-og.vercel.app](https://https://codinasion-og.vercel.app/)
